...
exports.deleteField = exports.updateData = exports.setData = exports.getCollection = exports.readData = void 0;
...
async function readData(docPath, field) {
...
async function getCollection(colPath) {
...
async function updateData(docPath, data) {
...
async function deleteField(col, doc, key) {
    let updates = {};
