import { ApplicationCommandData, ApplicationCommandOptionType, ApplicationCommandType, ChatInputCommandInteraction, Collection, Embed, EmbedBuilder, GuildMember, Message, Snowflake, User } from "discord.js";
