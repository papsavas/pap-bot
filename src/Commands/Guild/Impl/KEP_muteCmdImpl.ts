import { ApplicationCommandData, ApplicationCommandOptionType, ApplicationCommandType, ChatInputCommandInteraction, Collection, Colors, Embed, EmbedBuilder, Message, Snowflake, TextChannel } from "discord.js";
