import { ApplicationCommandType, Collection, Colors, ContextMenuCommandInteraction, Embed, EmbedBuilder, Message, MessageApplicationCommandData, MessageContextMenuCommandInteraction, RESTJSONErrorCodes, Snowflake, User } from "discord.js";
