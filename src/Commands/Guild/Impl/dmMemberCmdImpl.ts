import {
    ApplicationCommandOptionData, ApplicationCommandOptionType, ApplicationCommandType, ChatInputApplicationCommandData, ChatInputCommandInteraction, Collection, Colors, Embed, EmbedBuilder, GuildMember, Message, PermissionFlagsBits, PermissionResolvable, RESTJSONErrorCodes, Snowflake
} from 'discord.js';
