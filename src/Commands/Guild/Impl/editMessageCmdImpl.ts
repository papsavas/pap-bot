import { ApplicationCommandOptionData, ChatInputApplicationCommandData, Collection, CommandInteraction, Embed, Message, MessageEditOptions, Permissions, Snowflake, TextChannel } from 'discord.js';
